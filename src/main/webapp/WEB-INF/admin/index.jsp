...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header header header-demo">
        <div class="layui-main">
            <br>
            <p id="myaaa" class="layui-nav-item">山大二手交易平台</p>
...
<%--                    <img src="<%=basePath%>images/web/user/${admin.imgUrl}" class="layui-circle" style="border: 2px solid #A9B7B7;" width="35px" alt="">--%>
                ...
                <li class="layui-nav-item">
                    <a href="javascript:;" style="color: black">${admin.username}</a>
                ...
                <li class="layui-nav-item x-index"><a href="/goods/index" style="color: black">前台首页</a></li>
            </ul>
        </div>
    </div>
