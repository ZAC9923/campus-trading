    ...
    <body>
        <div id="header">
            <div class="header-wrap">
                ...
                <ul class="nav fl">
                    <li><a href="/goods/index">山大二手工坊</a></li>
                </ul>
                <div class="nav-right fr">
                    <c:if test="${!empty cur_user}">
                        <a href="/user/index" class="log-btn">
                            <img src="<%=request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort() %>/images/user/${cur_user.imgUrl}" class="user-header-image">${cur_user.username}</a>
                ...
                <div class="banner">
                    <div class="focusMap fl">
                        ...
                        <ul class="rImg">
                            ...
                            <img src="<%=basePath%>images/banner/3d1637a7-e58e-43c1-aca8-4051d3c53aa3.jpg" alt="${item.title}" title="${item.title}"></a>
                        </ul>
